```
git clone https://github.com/cypress-io/cypress-tutorial-build-todo-starter.git
...
added 867 packages from 651 contributors and audited 4792 packages in 80.5s
found 510 vulnerabilities (166 low, 13 moderate, 330 high, 1 critical)
...
+ cypress@3.4.0
+ axios@0.19.0
added 129 packages from 62 contributors, removed 54 packages, updated 16 packages and moved 26 packages in 84.412s
fixed 507 of 510 vulnerabilities in 4792 scanned packages
...
+ css-loader@3.1.0
added 11 packages from 11 contributors, removed 99 packages, updated 14 packages, moved 1 package and audited 6116 packages in 6.516s
...
- 「cypress/integration/input-form.spec.jp」を作成する。

- 画面に表示された「example.json」のリンクをクリックする。
